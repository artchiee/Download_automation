           ...
           # quality_number  = doc.xpath('//table/tbody/tr/td[3]')
            ...
            if result:
                ...
                if btn_link:
                    ...
                    print('exception')
                    # Not able to select diffrent qualities only(1080 Full-HD)
                counter = counter + 1
            ...
            driver.implicitly_wait(3)
            #Need to reload the button to be clickable
            green_btn = driver.find_element_by_link_text('Download')
            green_btn.click()
