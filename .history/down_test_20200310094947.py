...
def scrapp_dt():
    ...
    data = []
    div_one = driver.find_element_by_id('mainload')
    div_two = div_one.find_element_by_xpath('//div[2]/div[2]')
    table_loop = div_two.find_element_by_xpath('//table/tbody')
    ...
    stars = ''
    try:
        name = tbody_loop.find_element_by_xpath('//tr[1]/td/h1').text
        duration_time = tbody_loop.find_element_by_xpath('//tr[6]/td[2]').text
        year = '2000'
        stars = tbody_loop.find_element_by_xpath(
